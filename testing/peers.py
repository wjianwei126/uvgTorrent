...
tracker = UDPTracker("udp://tracker.coppersurfer.tk:6969", timeout=2, info_hash="9609f0336566953f3bf342241b25e2437f65b2c8")
tracker.connect()
...
tracker.scrape(["9609f0336566953f3bf342241b25e2437f65b2c8"])
print tracker.interpret()